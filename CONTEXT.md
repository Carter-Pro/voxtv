...
_Avoid_: command router, intent parser

**PromptPlayer**:
播放提示音（系统 beep 或 NSSound），唤醒后提示用户开始说话。
_Avoid_: chime player, notification sound
